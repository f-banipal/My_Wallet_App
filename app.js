...
const harcamayiDomaYaz = ({id, miktar, tarih, alan}) =>{
    ...
    tr.append(
        ...
        createLastTd()  // cop kutusu ve id ekler

    )
    // harcamaBody.append(tr)  // son girileni alta ekle
    harcamaBody.prepend(tr)  // son girileni basa ekle
}
//! HESAPLA VE GUNCELLE
...
temizleBtn.addEventListener('click', ()=>{
    if (confirm("Tum veriler silinecek. Devam etmek istiyor musun?")){
        harcamaListesi = []
        gelirler = 0
        harcamaBody.innerHTML = ""
       
        // localStorage.clear()  // tum localstorage i siler
        localStorage.removeItem("gelirler", "harcamalar")
        hesaplaVeGuncelle()
    }
})